...
(function () {
  ...
  function _d(s) { var t = new Date(now); t.setDate(t.getDate() - s); return t.toISOString().slice(0,10); }
    ...
    var _demoIssues = [
      { id: 'YZY-001', type: '围挡破损', fenceId: 'WD-2026-0001', fenceAddr: '福田区福华三路', details: '围挡面板破裂约0.5㎡，金属框架外露存在安全风险', status: '整改完成', source: '街道上报', reportTime: _d(1)+' 08:30:15', engineerName: '管道铺设工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', photos: ['../围挡破损.png'], location: { lat: 22.549, lng: 114.060, addr: '福田区福华三路与金田路交汇处' } },
{ id: 'YZY-002', type: '围挡脏污', fenceId: 'WD-2026-0002', fenceAddr: '福田区福华三路西侧', details: '围挡表面大面积泥浆污渍影响市容，面积约5㎡', status: '整改逾期', source: '监管巡查', reportTime: _d(7)+' 09:45:00', engineerName: '沟槽开挖工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', _rectification: {"rectTime": "2026-07-23 16:00:00", "rectifier": "刘伟", "rectifierUnit": "深圳市市政工程总公司", "desc": "已完成部分清洗，剩余顽固污渍因连续降雨无法彻底清除", "photos": ["../围挡破损.png"]}, photos: ['../围挡破损.png'], location: { lat: 22.547, lng: 114.059, addr: '福田区福华三路西侧' } },
      { id: 'YZY-003', type: '围挡安全隐患', fenceId: 'WD-2026-0002', fenceAddr: '福田区福华三路西侧', details: '围挡整体向西侧倒塌约15米，底部基础完全裸露', status: '待整改', source: '监管巡查', reportTime: _d(5)+' 10:15:30', engineerName: '沟槽开挖工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', _transfers: [{"time": "2026-07-24 09:00:00", operator: '张建国', unit: '深圳市福田区住建局', desc: '转派至福田街道办督促整改', originalEng: '沟槽开挖工程', transferEng: '管道铺设工程'}], photos: ['../围挡破损.png'], location: { lat: 22.546, lng: 114.060, addr: '福田区福华三路西侧' } },
{ id: 'YZY-011', type: '围挡基础松动', fenceId: 'WD-2026-0001', fenceAddr: '福田区福华三路', details: '巡检中发现围挡底部基础螺栓松动3处，已当日加固修复', status: '整改完成', source: '项目巡检', reportTime: _d(8)+' 09:20:00', engineerName: '管道铺设工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', _rectification: {"rectTime": "2026-07-22 16:00:00", "rectifier": "刘伟", "rectifierUnit": "深圳市市政工程总公司", "desc": "紧固3处松动螺栓并做防锈处理", "photos": ["../围挡破损.png"]}, photos: ['../围挡破损.png'], location: { lat: 22.550, lng: 114.061, addr: '福田区福华三路与金田路交汇处' } },
      { id: 'YZY-012', type: '围挡脏污', fenceId: 'WD-2026-0002', fenceAddr: '福田区福华三路西侧', details: '巡检中发现围挡表面有泥浆泼溅痕迹约2㎡，已清洗完毕', status: '整改完成', source: '项目巡检', reportTime: _d(9)+' 14:50:00', engineerName: '沟槽开挖工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', photos: ['../围挡破损.png'], location: { lat: 22.547, lng: 114.060, addr: '福田区福华三路西侧' } },
      ...
      { id: 'YZY-018', type: '围挡破损', fenceId: 'WD-2026-0001', fenceAddr: '南山区科技南路18号东北角', details: '围挡破损人可通行', status: '待整改', source: '监管巡查', reportTime: '2026-07-22 10:30:00', engineerName: '绿化迁移工程', _projectName: '南山区科技园综合体项目', responsibleUnit: '深圳市绿篱建设工程有限公司', supervisor: '张建国', photos: ['../围挡破损.png'], location: { lat: 22.5372, lng: 113.9598, addr: '南山区科技南路18号东北角围挡范围处' } },
      { id: 'YZY-013', type: '围挡脏污', fenceId: 'WD-2026-0001', fenceAddr: '福田区福华三路', details: '围挡表面有大量泥浆泼溅，影响城市市容，请尽快清洗处理', status: '待整改', source: '街道上报', reportTime: _d(2)+' 15:20:00', engineerName: '管道铺设工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', street: '福田街道', photos: ['../围挡破损.png'], location: { lat: 22.549, lng: 114.062, addr: '福田区福华三路金田路口东侧' } },
      { id: 'YZY-014', type: '围挡缺失', fenceId: 'WD-2026-0002', fenceAddr: '福田区福华三路西侧', details: '围挡西段缺失约8米，缺口处行人可随意进出施工区域，存在严重安全隐患', status: '待整改', source: '街道上报', reportTime: _d(3)+' 10:45:00', engineerName: '沟槽开挖工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', street: '福田街道', _transfers: [{"time": "2026-07-26 09:00:00", "operator": "张建国", "unit": "深圳市福田区住建局", "desc": "转派至福田街道办督促修复缺失围挡", "originalEng": "沟槽开挖工程", transferEng: '管道铺设工程'}], photos: ['../围挡破损.png'], location: { lat: 22.547, lng: 114.059, addr: '福田区福华三路西侧围挡缺口处' } },
{ id: 'YZY-015', type: '张贴小广告', fenceId: 'WD-2026-0001', fenceAddr: '福田区福华三路', details: '围挡立面被张贴大量小广告，面积约3㎡，影响市容整洁度', status: '整改逾期', source: '街道上报', reportTime: _d(9)+' 11:10:00', engineerName: '管道铺设工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', street: '福田街道', _rectification: {"rectTime": "2026-07-21 16:00:00", "rectifier": "刘伟", "rectifierUnit": "深圳市市政工程总公司", "desc": "已清除全部小广告，重新涂刷防粘贴涂层", "photos": ["../围挡破损.png"]}, photos: ['../围挡破损.png'], location: { lat: 22.549, lng: 114.063, addr: '福田区福华三路中段' } },
      { id: 'YZY-016', type: '围挡安全隐患', fenceId: 'WD-2026-0001', fenceAddr: '福田区福华三路', details: '围挡面板连接处多处锈蚀严重，遇大风天气存在倒塌风险，需紧急加固', status: '待整改', source: '街道上报', reportTime: _d(1)+' 16:30:00', engineerName: '管道铺设工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', street: '福田街道', _transfers: [{"time": "2026-07-28 09:00:00", "operator": "张建国", "unit": "深圳市福田区住建局", "desc": "转派至项目施工单位紧急加固", "originalEng": "管道铺设工程", transferEng: '沟槽开挖工程'}], photos: ['../围挡破损.png'], location: { lat: 22.550, lng: 114.060, addr: '福田区福华三路与金田路交汇处北侧' } },
      ...
      // ── 新增：南山项目问题 ──
      { id: 'YZY-019', type: '围挡安全隐患', fenceId: 'WD-2026-0002', fenceAddr: '南山区科技南路18号北侧', details: '基坑支护围挡底部排水沟堵塞，雨季积水浸泡围挡基础,存在沉降倾倒风险', status: '待整改', source: '监管巡查', reportTime: _d(3)+' 09:15:00', engineerName: '基坑支护工程', _projectName: '南山区科技园综合体项目', responsibleUnit: '深圳市岩土工程有限公司', supervisor: '张建国', photos: ['../围挡破损.png'], location: { lat: 22.5375, lng: 113.958, addr: '南山区科技南路18号北侧基坑入口处' } },
      { id: 'YZY-020', type: '围挡破损', fenceId: 'WD-2026-0002', fenceAddr: '南山区科技南路18号北侧', details: '围挡面板左上角碰撞破损约0.3㎡，面板边缘锋利可能划伤行人', status: '整改完成', source: '项目巡检', reportTime: _d(2)+' 14:20:00', engineerName: '基坑支护工程', _projectName: '南山区科技园综合体项目', responsibleUnit: '深圳市岩土工程有限公司', photos: ['../围挡破损.png'], location: { lat: 22.538, lng: 113.959, addr: '南山区科技南路18号北侧围挡中段' } },
      { id: 'YZY-021', type: '围挡脏污', fenceId: 'WD-2026-0001', fenceAddr: '南山区科技南路18号东北角', details: '仿真绿篱围挡表面有多处泥浆溅痕，面积合计约2㎡，影响绿篱美观效果', status: '整改逾期', source: '街道上报', reportTime: _d(6)+' 10:30:00', engineerName: '绿化迁移工程', _projectName: '南山区科技园综合体项目', responsibleUnit: '深圳市绿篱建设工程有限公司', street: '粤海街道', photos: ['../围挡破损.png'], location: { lat: 22.537, lng: 113.960, addr: '南山区科技南路18号绿篱入口附近' } },
      { id: 'YZY-022', type: '围挡基础松动', fenceId: 'WD-2026-0002', fenceAddr: '南山区科技南路18号北侧', details: '基坑支护围挡北段基础预埋件3处螺栓锈蚀松动，需重新紧固并做防腐处理', status: '待整改', source: '项目巡检', reportTime: _d(1)+' 11:00:00', engineerName: '基坑支护工程', _projectName: '南山区科技园综合体项目', responsibleUnit: '深圳市岩土工程有限公司', photos: ['../围挡破损.png'], location: { lat: 22.5385, lng: 113.958, addr: '南山区科技南路18号基坑支护围挡北段' } },
      { id: 'YZY-023', type: '张贴小广告', fenceId: 'WD-2026-0003', fenceAddr: '南山区科技南路18号南侧', details: '已拆除围挡区域围挡立柱上残留大量广告贴纸，影响市容整洁', status: '整改完成', source: '街道上报', reportTime: _d(4)+' 09:50:00', engineerName: '土方回填工程', _projectName: '南山区科技园综合体项目', responsibleUnit: '中建三局集团有限公司', street: '粤海街道', photos: ['../围挡破损.png'], location: { lat: 22.534, lng: 113.958, addr: '南山区科技南路18号南侧' } },
      // ── 新增：教学楼项目问题 ──
      { id: 'YZY-024', type: '围挡安全隐患', fenceId: 'WD-2026-0004', fenceAddr: '龙华区民治街道民丰路88号', details: '教学楼施工围挡东段倾斜约10度，支撑杆件有3根弯曲变形，遇强风天气存在倒塌风险', status: '待整改', source: '监管巡查', reportTime: _d(2)+' 15:40:00', engineerName: '教学楼主体工程', _projectName: '龙华区民治街道学校扩建项目', responsibleUnit: '深圳市建工集团股份有限公司', supervisor: '张建国', photos: ['../围挡破损.png'], location: { lat: 22.629, lng: 114.043, addr: '龙华区民治街道民丰路88号教学楼东侧' } },
      { id: 'YZY-025', type: '围挡缺失', fenceId: 'WD-2026-0004', fenceAddr: '龙华区民治街道民丰路88号', details: '教学楼围挡人行通道处缺失一段约3米，学生可随意进出施工区域，存在严重安全隐患', status: '待整改', source: '街道上报', reportTime: _d(1)+' 08:25:00', engineerName: '教学楼主体工程', _projectName: '龙华区民治街道学校扩建项目', responsibleUnit: '深圳市建工集团股份有限公司', street: '民治街道', photos: ['../围挡破损.png'], location: { lat: 22.628, lng: 114.043, addr: '龙华区民治街道民丰路88号人行通道处' } },
      { id: 'YZY-026', type: '公益广告污损', fenceId: 'WD-2026-0004', fenceAddr: '龙华区民治街道民丰路88号', details: '教学楼围挡公益广告画面有3处大面积破损褪色，面积约4㎡，广告内容模糊不清', status: '整改逾期', source: '项目巡检', reportTime: _d(8)+' 16:10:00', engineerName: '教学楼主体工程', _projectName: '龙华区民治街道学校扩建项目', responsibleUnit: '深圳市建工集团股份有限公司', photos: ['../围挡破损.png'], location: { lat: 22.630, lng: 114.042, addr: '龙华区民治街道民丰路88号教学楼西侧围挡' } },
      // ── 新增：未知项目问题 ──
...
{ id: 'YZY-029', type: '围挡喷淋不符合要求', fenceId: 'WD-2026-0001', fenceAddr: '南山区科技南路18号东北角', details: '绿化迁移围挡喷淋设施3处喷头堵塞不出水，不符合文明施工要求', status: '整改完成', source: '项目巡检', reportTime: _d(3)+' 08:45:00', engineerName: '绿化迁移工程', _projectName: '南山区科技园综合体项目', responsibleUnit: '深圳市绿篱建设工程有限公司', _rectification: {"rectTime": "2026-07-27 16:00:00", "rectifier": "王强", "rectifierUnit": "深圳市绿篱建设工程有限公司", "desc": "已疏通3处堵塞喷头并更换损坏的喷淋头", "photos": ["../围挡破损.png"]}, photos: ['../围挡破损.png'], location: { lat: 22.5365, lng: 113.960, addr: '南山区科技南路18号东北角绿化围挡处' } },
      { id: 'YZY-030', type: '围挡安全隐患', fenceId: 'WD-2026-0002', fenceAddr: '南山区科技南路18号北侧', details: '围挡面板底部与基础连接处4处螺栓锈蚀严重，存在围挡倾覆安全隐患', status: '整改逾期', source: '街道上报', reportTime: _d(5)+' 14:00:00', engineerName: '基坑支护工程', _projectName: '南山区科技园综合体项目', responsibleUnit: '深圳市岩土工程有限公司', street: '粤海街道', photos: ['../围挡破损.png'], location: { lat: 22.537, lng: 113.9575, addr: '南山区科技南路18号北侧围挡面板连接处' } },
      { id: 'YZY-031', type: '围挡脏污', fenceId: 'WD-2026-0003', fenceAddr: '南山区科技南路18号南侧', details: '已拆除围挡区域内遗留围挡板材未及时清理，表面大面积泥浆污渍约4㎡', status: '待整改', source: '监管巡查', reportTime: _d(2)+' 10:20:00', engineerName: '土方回填工程', _projectName: '南山区科技园综合体项目', responsibleUnit: '中建三局集团有限公司', supervisor: '张建国', photos: ['../围挡破损.png'], location: { lat: 22.534, lng: 113.959, addr: '南山区科技南路18号南侧拆除区域' } },
      { id: 'YZY-032', type: '围挡破损', fenceId: 'WD-2026-0003', fenceAddr: '南山区科技南路18号南侧', details: '已拆除围挡区域立柱底部混凝土基座破损断裂，钢筋外露，影响人行通行', status: '整改逾期', source: '街道上报', reportTime: _d(7)+' 09:30:00', engineerName: '土方回填工程', _projectName: '南山区科技园综合体项目', responsibleUnit: '中建三局集团有限公司', street: '粤海街道', photos: ['../围挡破损.png'], location: { lat: 22.5335, lng: 113.958, addr: '南山区科技南路18号南侧人行道旁' } },
{ id: 'YZY-033', type: '围挡公益广告画面不连贯', fenceId: 'WD-2026-0004', fenceAddr: '龙华区民治街道民丰路88号', details: '教学楼围挡公益广告画面在东南角转角处断开约2米，整体视觉效果不连贯', status: '整改完成', source: '项目巡检', reportTime: _d(6)+' 14:50:00', engineerName: '教学楼主体工程', _projectName: '龙华区民治街道学校扩建项目', responsibleUnit: '深圳市建工集团股份有限公司', _rectification: {"rectTime": "2026-07-24 16:00:00", "rectifier": "周文", "rectifierUnit": "深圳市建工集团股份有限公司", "desc": "已补全转角处缺失的公益广告画面，整体连贯", "photos": ["../围挡破损.png"]}, photos: ['../围挡破损.png'], location: { lat: 22.628, lng: 114.044, addr: '龙华区民治街道民丰路88号教学楼东南角围挡' } },
      // ── 群众上报演示数据 ──
      { id: 'YZY-034', type: '围挡破损', fenceId: 'WD-2026-0001', fenceAddr: '福田区福华三路', details: '福华三路围挡靠近人行道处有一块面板脱落，露出内部钢架，行人经过容易刮伤', status: '整改完成', source: '群众上报', reportTime: _d(5)+' 10:20:00', engineerName: '管道铺设工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', _rectification: {"rectTime": "2026-07-25 14:00:00", "rectifier": "刘伟", "rectifierUnit": "深圳市市政工程总公司", "desc": "已更换脱落面板，焊缝加固并打磨锋利边缘", "photos": ["../围挡破损.png"]}, photos: ['../围挡破损.png'], location: { lat: 22.550, lng: 114.062, addr: '福田区福华三路靠近人行道处' } },
      { id: 'YZY-035', type: '围挡脏污', fenceId: 'WD-2026-0001', fenceAddr: '福田区福华三路', details: '围挡表面有大面积泥浆污渍，下雨后泥水顺着围挡流到人行道上，影响通行', status: '待整改', source: '群众上报', reportTime: _d(2)+' 08:45:00', engineerName: '管道铺设工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', photos: ['../围挡破损.png'], location: { lat: 22.550, lng: 114.061, addr: '福田区福华三路人行道旁' } },
      { id: 'YZY-036', type: '围挡安全隐患', fenceId: 'WD-2026-0002', fenceAddr: '福田区福华三路西侧', details: '围挡西段靠近路口处有明显倾斜，刮风天晃动厉害，担心会倒下来砸到行人', status: '待整改', source: '群众上报', reportTime: _d(1)+' 18:30:00', engineerName: '沟槽开挖工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', photos: ['../围挡破损.png'], location: { lat: 22.547, lng: 114.059, addr: '福田区福华三路西侧路口处' } }
    ];
          ...
          hoardings: [
            ...
            },
            {
              ...
              changeRecords: [
                ...
                { id: 'cr_jk2', changer: '张项目', unit: '深圳市岩土工程有限公司', role: '项目负责人', date: '2026-06-10 14:30', type: '认领操作', content: '基坑支护工程正式认领接管该围挡', before: '待认领', after: '基坑支护工程' }
              ],
              patrolRecords: [
          ...
          hoardings: [
            {
              ...
              changeRecords: [
                ...
                { id: 'cr_lh3', changer: '张项目', unit: '深圳市建工集团股份有限公司', role: '项目负责人', date: '2026-07-20 10:00', type: '取消移交', content: '取消前次移交操作，围挡恢复已安装状态', before: '待认领', after: '教学楼主体工程' }
              ],
              patrolRecords: [
