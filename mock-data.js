          ...
          hoardings: [
            {
              ...
              patrolRecords: [
                ...
                { id: 'pr10', date: '2026-05-09', time: '15:20', inspector: '刘伟', result: '异常', issues: [{type:'围挡脏污', detail:'围挡面板表面有轻微泥浆污渍，面积约0.2㎡，不影响结构安全但需清洁'}], panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1' },
                ...
                { id: 'pr27', date: '2026-06-14', time: '09:30', inspector: '刘伟', result: '异常', issues: [{type:'围挡面板变形', detail:'巡检发现围挡面板因大风天气导致局部变形约0.8㎡，面板连接处出现松动，需更换面板并加固连接件'}], panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1' },
                ...
                { id: 'pr47', date: '2026-06-22', time: '15:40', inspector: '刘伟', result: '异常', issues: [{type:'围挡脏污', detail:'下午巡查发现围挡面板有新增泥浆泼溅痕迹约1.5㎡，疑为附近施工车辆经过溅起'}], panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1' },

                { id: 'pr_gen_5000', date: '2026-06-25', time: '08:25', inspector: '陈刚', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡基础松动', detail:'围挡底部与地面连接处轻微松动，螺栓需紧固'}] },
                { id: 'pr_gen_5005', date: '2026-06-27', time: '08:27', inspector: '王强', result: '异常', panoramaSrc: 'https://ips.cscecsteel.com/kgsy/projectTourist/9018a67e-e58b-4283-9cf6-4eae3d515492', issues: [{type:'围挡面板变形', detail:'巡检发现围挡面板因风雨天气局部变形约0.5㎡，连接处松动'}] },
                ...
                { id: 'pr_gen_5040', date: '2026-07-08', time: '08:08', inspector: '刘伟', result: '异常', panoramaSrc: 'https://vsleem.com/scene/realsee/share?projectId=2183&patrolId=eff873ee90a9c39da9731b17789f9291&pointId=4d55d097-2e0d-4db5-b88a-a313b002cf2b&rotate=1.8900753669526844,-0.09621686902020032&authCode=70c29c3c9b5a40c8acd5567358e1c78b', issues: [{type:'围挡脏污', detail:'围挡面板表面有轻微泥浆污渍，面积约0.3㎡，不影响结构安全但需清洁'}] },
                ...
                { id: 'pr_gen_5055', date: '2026-07-13', time: '08:13', inspector: '王强', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡面板变形', detail:'巡检发现围挡面板因风雨天气局部变形约0.5㎡，连接处松动'}] },
                { id: 'pr_gen_5060', date: '2026-07-15', time: '08:15', inspector: '刘伟', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡脏污', detail:'围挡面板表面有轻微泥浆污渍，面积约0.3㎡，不影响结构安全但需清洁'}] },
                { id: 'pr_gen_5065', date: '2026-07-17', time: '08:17', inspector: '刘伟', result: '正常', panoramaSrc: 'https://vsleem.com/scene/realsee/share?projectId=2183&patrolId=eff873ee90a9c39da9731b17789f9291&pointId=4d55d097-2e0d-4db5-b88a-a313b002cf2b&rotate=1.8900753669526844,-0.09621686902020032&authCode=70c29c3c9b5a40c8acd5567358e1c78b' },
                { id: 'pr_gen_5070', date: '2026-07-18', time: '08:18', inspector: '陈刚', result: '异常', panoramaSrc: 'https://ips.cscecsteel.com/kgsy/projectTourist/9018a67e-e58b-4283-9cf6-4eae3d515492', issues: [{type:'围挡基础松动', detail:'围挡底部与地面连接处轻微松动，螺栓需紧固'}] },
                { id: 'pr_gen_5075', date: '2026-07-20', time: '08:20', inspector: '王强', result: '异常', panoramaSrc: 'https://vsleem.com/scene/realsee/share?projectId=2183&patrolId=eff873ee90a9c39da9731b17789f9291&pointId=4d55d097-2e0d-4db5-b88a-a313b002cf2b&rotate=1.8900753669526844,-0.09621686902020032&authCode=70c29c3c9b5a40c8acd5567358e1c78b', issues: [{type:'围挡面板变形', detail:'巡检发现围挡面板因风雨天气局部变形约0.5㎡，连接处松动'}] },
                { id: 'pr_gen_5080', date: '2026-07-22', time: '08:22', inspector: '刘伟', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡脏污', detail:'围挡面板表面有轻微泥浆污渍，面积约0.3㎡，不影响结构安全但需清洁'}] },
                { id: 'pr_gen_5085', date: '2026-07-23', time: '08:23', inspector: '陈刚', result: '正常', panoramaSrc: 'https://vsleem.com/scene/realsee/share?projectId=2183&patrolId=eff873ee90a9c39da9731b17789f9291&pointId=4d55d097-2e0d-4db5-b88a-a313b002cf2b&rotate=1.8900753669526844,-0.09621686902020032&authCode=70c29c3c9b5a40c8acd5567358e1c78b' },
                { id: 'pr_gen_5090', date: '2026-07-25', time: '08:25', inspector: '陈刚', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡基础松动', detail:'围挡底部与地面连接处轻微松动，螺栓需紧固'}] },
                { id: 'pr_gen_5095', date: '2026-07-27', time: '08:27', inspector: '王强', result: '异常', panoramaSrc: 'https://ips.cscecsteel.com/kgsy/projectTourist/9018a67e-e58b-4283-9cf6-4eae3d515492', issues: [{type:'围挡面板变形', detail:'巡检发现围挡面板因风雨天气局部变形约0.5㎡，连接处松动'}] },
            ...
            },
            {
              ...
              patrolRecords: [
                { id: 'pr3', date: '2026-05-10', time: '10:00', inspector: '刘伟', result: '异常', issues: [{type:'围挡尺寸不合规', detail:'围挡实测高度2.0m，低于规范要求的2.5m标准高度，需立即调整'}], panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1' },
                ...
                { id: 'pr19', date: '2026-05-17', time: '16:00', inspector: '刘伟', result: '异常', issues: [{type:'围挡基础松动', detail:'围挡面板之间连接螺栓松动3处，连接件存在脱落风险，需紧固或更换'}], panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1' },
                ...
                { id: 'pr28', date: '2026-06-13', time: '10:00', inspector: '陈刚', result: '异常', issues: [{type:'围挡公益广告脱落', detail:'围挡外侧公益广告喷绘布因连日降雨导致大面积脱胶起泡约3㎡，公益广告内容已无法看清，影响市容市貌，需重新制作更换喷绘布面'}], panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1' },
                { id: 'pr43', date: '2026-06-22', time: '10:00', inspector: '陈刚', result: '异常', issues: [{type:'围挡公益广告脱落', detail:'围挡外侧公益广告喷绘布大面积脱胶起泡约3㎡'},{type:'围挡尺寸不合规', detail:'围挡实测高度2.0m，低于规范要求的2.5m标准高度'}], panoramaSrc: 'https://ips.cscecsteel.com/kgsy/projectTourist/9018a67e-e58b-4283-9cf6-4eae3d515492' }
              ,
                { id: 'pr_gen_5001', date: '2026-06-24', time: '09:37', inspector: '陈刚', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡基础松动', detail:'围挡底部与地面连接处轻微松动，螺栓需紧固'}] },
                { id: 'pr_gen_5006', date: '2026-06-26', time: '09:39', inspector: '王强', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡面板变形', detail:'巡检发现围挡面板因风雨天气局部变形约0.5㎡，连接处松动'}] },
                ...
                { id: 'pr_gen_5026', date: '2026-07-03', time: '09:16', inspector: '陈刚', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡基础松动', detail:'围挡底部与地面连接处轻微松动，螺栓需紧固'}] },
                { id: 'pr_gen_5031', date: '2026-07-04', time: '09:17', inspector: '李巡检', result: '正常', panoramaSrc: 'https://vsleem.com/scene/realsee/share?projectId=2183&patrolId=eff873ee90a9c39da9731b17789f9291&pointId=4d55d097-2e0d-4db5-b88a-a313b002cf2b&rotate=1.8900753669526844,-0.09621686902020032&authCode=70c29c3c9b5a40c8acd5567358e1c78b' },
                { id: 'pr_gen_5036', date: '2026-07-06', time: '09:19', inspector: '陈刚', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡脏污', detail:'围挡面板表面有泥浆污渍约0.5㎡，需清洁处理'}] },
                ...
                { id: 'pr_gen_5061', date: '2026-07-14', time: '09:27', inspector: '刘伟', result: '异常', panoramaSrc: 'https://ips.cscecsteel.com/kgsy/projectTourist/9018a67e-e58b-4283-9cf6-4eae3d515492', issues: [{type:'围挡脏污', detail:'围挡面板表面有轻微泥浆污渍，面积约0.3㎡，不影响结构安全但需清洁'}] },
                ...
                { id: 'pr_gen_5081', date: '2026-07-21', time: '09:34', inspector: '刘伟', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡脏污', detail:'围挡面板表面有轻微泥浆污渍，面积约0.3㎡，不影响结构安全但需清洁'}] },
                ...
                { id: 'pr_gen_5091', date: '2026-07-24', time: '09:37', inspector: '陈刚', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡基础松动', detail:'围挡底部与地面连接处轻微松动，螺栓需紧固'}] },
                { id: 'pr_gen_5096', date: '2026-07-26', time: '09:39', inspector: '王强', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡面板变形', detail:'巡检发现围挡面板因风雨天气局部变形约0.5㎡，连接处松动'}] },
                ...
                { id: 'pr_gen_5111', date: '2026-07-31', time: '09:44', inspector: '陈刚', result: '异常', panoramaSrc: 'https://vsleem.com/scene/realsee/share?projectId=2183&patrolId=eff873ee90a9c39da9731b17789f9291&pointId=4d55d097-2e0d-4db5-b88a-a313b002cf2b&rotate=1.8900753669526844,-0.09621686902020032&authCode=70c29c3c9b5a40c8acd5567358e1c78b', issues: [{type:'围挡基础松动', detail:'围挡底部与地面连接处轻微松动，螺栓需紧固'}] },
            ...
            },
            {
              ...
              patrolRecords: [
                { id: 'pr4', date: '2026-05-08', time: '11:00', inspector: '陈刚', result: '异常', issues: [{type:'围挡材质不符合规范', detail:'现场围挡使用PVC材质，不符合装配式钢结构喷绘围挡的设计要求，需更换为规范材质'},{type:'围挡超期未拆除', detail:'该围挡已于2025-06-01到期，至今未拆除，属于超期围挡，需立即拆除或办理延期手续'}], panoramaSrc: 'https://vsleem.com/scene/realsee/share?projectId=2183&patrolId=eff873ee90a9c39da9731b17789f9291&pointId=4d55d097-2e0d-4db5-b88a-a313b002cf2b&rotate=1.8900753669526844,-0.09621686902020032&authCode=70c29c3c9b5a40c8acd5567358e1c78b' },
                ...
                { id: 'pr29', date: '2026-06-15', time: '08:30', inspector: '刘伟', result: '异常', issues: [{type:'围挡喷淋系统失效', detail:'围挡顶端喷淋降尘系统管道破裂导致水压不足，仅1/3喷头正常出水，无法满足降尘要求，需整体检修喷淋管道及更换破损管段'}], panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1' }
              ,
                { id: 'pr_gen_5002', date: '2026-06-24', time: '10:50', inspector: '李巡检', result: '正常', panoramaSrc: 'https://vsleem.com/scene/realsee/share?projectId=2183&patrolId=eff873ee90a9c39da9731b17789f9291&pointId=4d55d097-2e0d-4db5-b88a-a313b002cf2b&rotate=1.8900753669526844,-0.09621686902020032&authCode=70c29c3c9b5a40c8acd5567358e1c78b' },
                { id: 'pr_gen_5007', date: '2026-06-25', time: '10:51', inspector: '王强', result: '异常', panoramaSrc: 'https://ips.cscecsteel.com/kgsy/projectTourist/9018a67e-e58b-4283-9cf6-4eae3d515492', issues: [{type:'围挡面板变形', detail:'巡检发现围挡面板因风雨天气局部变形约0.5㎡，连接处松动'}] },
                ...
                { id: 'pr_gen_5027', date: '2026-07-02', time: '10:28', inspector: '陈刚', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡基础松动', detail:'围挡底部与地面连接处轻微松动，螺栓需紧固'}] },
                { id: 'pr_gen_5032', date: '2026-07-04', time: '10:30', inspector: '王强', result: '异常', panoramaSrc: 'https://ips.cscecsteel.com/kgsy/projectTourist/9018a67e-e58b-4283-9cf6-4eae3d515492', issues: [{type:'围挡面板变形', detail:'巡检发现围挡面板因风雨天气局部变形约0.5㎡，连接处松动'}] },
                ...
                { id: 'pr_gen_5057', date: '2026-07-12', time: '10:38', inspector: '陈刚', result: '异常', panoramaSrc: 'https://vsleem.com/scene/realsee/share?projectId=2183&patrolId=eff873ee90a9c39da9731b17789f9291&pointId=4d55d097-2e0d-4db5-b88a-a313b002cf2b&rotate=1.8900753669526844,-0.09621686902020032&authCode=70c29c3c9b5a40c8acd5567358e1c78b', issues: [{type:'围挡脏污', detail:'围挡面板表面有泥浆污渍约0.5㎡，需清洁处理'}] },
                ...
                { id: 'pr_gen_5072', date: '2026-07-17', time: '10:43', inspector: '李巡检', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡脏污', detail:'围挡面板表面有泥浆污渍约0.5㎡，需清洁处理'}] },
                ...
                { id: 'pr_gen_5082', date: '2026-07-20', time: '10:46', inspector: '刘伟', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡脏污', detail:'围挡面板表面有轻微泥浆污渍，面积约0.3㎡，不影响结构安全但需清洁'}] },
                ...
                { id: 'pr_gen_5097', date: '2026-07-25', time: '10:51', inspector: '王强', result: '异常', panoramaSrc: 'https://ips.cscecsteel.com/kgsy/projectTourist/9018a67e-e58b-4283-9cf6-4eae3d515492', issues: [{type:'围挡面板变形', detail:'巡检发现围挡面板因风雨天气局部变形约0.5㎡，连接处松动'}] },
          ...
          hoardings: [
            {
              ...
              patrolRecords: [
                ...
                { id: 'pr35', date: '2026-06-16', time: '11:20', inspector: '王强', result: '异常', issues: [{type:'围挡基础沉降', detail:'基坑围护工程围挡东南角基础出现不均匀沉降约5cm，围挡立柱倾斜约8度，面板间缝隙增大，需要对沉降区域进行注浆加固并校正立柱垂直度'}], panoramaSrc: 'https://ips.cscecsteel.com/kgsy/projectTourist/9018a67e-e58b-4283-9cf6-4eae3d515492' },
                { id: 'pr45', date: '2026-06-22', time: '11:20', inspector: '王强', result: '异常', issues: [{type:'围挡基础沉降', detail:'基坑围护工程围挡东南角基础出现不均匀沉降约5cm，围挡立柱倾斜约8度'}], panoramaSrc: 'https://ips.cscecsteel.com/kgsy/projectTourist/9018a67e-e58b-4283-9cf6-4eae3d515492' },
              ...
              ,
                ...
                { id: 'pr_gen_5023', date: '2026-07-01', time: '11:40', inspector: '陈刚', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡基础松动', detail:'围挡底部与地面连接处轻微松动，螺栓需紧固'}] },
                { id: 'pr_gen_5028', date: '2026-07-03', time: '11:42', inspector: '王强', result: '异常', panoramaSrc: 'https://ips.cscecsteel.com/kgsy/projectTourist/9018a67e-e58b-4283-9cf6-4eae3d515492', issues: [{type:'围挡面板变形', detail:'巡检发现围挡面板因风雨天气局部变形约0.5㎡，连接处松动'}] },
                ...
                { id: 'pr_gen_5043', date: '2026-07-08', time: '11:47', inspector: '陈刚', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡基础松动', detail:'围挡底部与地面连接处轻微松动，螺栓需紧固'}] },
                { id: 'pr_gen_5048', date: '2026-07-10', time: '11:49', inspector: '王强', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡面板变形', detail:'巡检发现围挡面板因风雨天气局部变形约0.5㎡，连接处松动'}] },
                ...
                { id: 'pr_gen_5063', date: '2026-07-15', time: '11:54', inspector: '陈刚', result: '异常', panoramaSrc: 'https://ips.cscecsteel.com/kgsy/projectTourist/9018a67e-e58b-4283-9cf6-4eae3d515492', issues: [{type:'围挡基础松动', detail:'围挡底部与地面连接处轻微松动，螺栓需紧固'}] },
                ...
                { id: 'pr_gen_5088', date: '2026-07-23', time: '11:02', inspector: '李巡检', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡脏污', detail:'围挡面板表面有泥浆污渍约0.5㎡，需清洁处理'}] },
                ...
                { id: 'pr_gen_5113', date: '2026-07-31', time: '11:10', inspector: '王强', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡面板变形', detail:'巡检发现围挡面板因风雨天气局部变形约0.5㎡，连接处松动'}] },
            ...
            },
            {
              ...
              patrolRecords: [
                ...
                { id: 'pr41', date: '2026-06-17', time: '10:30', inspector: '李巡检', result: '异常', issues: [{type:'围挡占道超限', detail:'主体结构工程围挡外堆放的钢筋加工成品超出占道许可范围约4m，严重挤占非机动车道，影响早晚高峰非机动车通行安全，需立即清理超占区域'}], panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1' }
              ,
                ...
                { id: 'pr_gen_5019', date: '2026-06-29', time: '08:21', inspector: '李巡检', result: '异常', panoramaSrc: 'https://ips.cscecsteel.com/kgsy/projectTourist/9018a67e-e58b-4283-9cf6-4eae3d515492', issues: [{type:'围挡脏污', detail:'围挡面板表面有泥浆污渍约0.5㎡，需清洁处理'}] },
                { id: 'pr_gen_5024', date: '2026-07-01', time: '08:53', inspector: '李巡检', result: '正常', panoramaSrc: 'https://vsleem.com/scene/realsee/share?projectId=2183&patrolId=eff873ee90a9c39da9731b17789f9291&pointId=4d55d097-2e0d-4db5-b88a-a313b002cf2b&rotate=1.8900753669526844,-0.09621686902020032&authCode=70c29c3c9b5a40c8acd5567358e1c78b' },
                { id: 'pr_gen_5029', date: '2026-07-02', time: '08:54', inspector: '王强', result: '异常', panoramaSrc: 'https://ips.cscecsteel.com/kgsy/projectTourist/9018a67e-e58b-4283-9cf6-4eae3d515492', issues: [{type:'围挡面板变形', detail:'巡检发现围挡面板因风雨天气局部变形约0.5㎡，连接处松动'}] },
                { id: 'pr_gen_5034', date: '2026-07-04', time: '08:56', inspector: '刘伟', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡脏污', detail:'围挡面板表面有轻微泥浆污渍，面积约0.3㎡，不影响结构安全但需清洁'}] },
                ...
                { id: 'pr_gen_5049', date: '2026-07-09', time: '08:01', inspector: '王强', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡面板变形', detail:'巡检发现围挡面板因风雨天气局部变形约0.5㎡，连接处松动'}] },
                { id: 'pr_gen_5054', date: '2026-07-11', time: '08:03', inspector: '刘伟', result: '异常', panoramaSrc: 'https://ips.cscecsteel.com/kgsy/projectTourist/9018a67e-e58b-4283-9cf6-4eae3d515492', issues: [{type:'围挡脏污', detail:'围挡面板表面有轻微泥浆污渍，面积约0.3㎡，不影响结构安全但需清洁'}] },
                { id: 'pr_gen_5059', date: '2026-07-12', time: '08:04', inspector: '陈刚', result: '正常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1' },
                { id: 'pr_gen_5064', date: '2026-07-14', time: '08:06', inspector: '陈刚', result: '异常', panoramaSrc: 'https://ips.cscecsteel.com/kgsy/projectTourist/9018a67e-e58b-4283-9cf6-4eae3d515492', issues: [{type:'围挡基础松动', detail:'围挡底部与地面连接处轻微松动，螺栓需紧固'}] },
                ...
                { id: 'pr_gen_5084', date: '2026-07-21', time: '08:13', inspector: '陈刚', result: '异常', panoramaSrc: 'https://www.720yun.com/vr/1c1jt7mOey1', issues: [{type:'围挡基础松动', detail:'围挡底部与地面连接处轻微松动，螺栓需紧固'}] },
                ...
                { id: 'pr_gen_5109', date: '2026-07-29', time: '08:21', inspector: '李巡检', result: '异常', panoramaSrc: 'https://ips.cscecsteel.com/kgsy/projectTourist/9018a67e-e58b-4283-9cf6-4eae3d515492', issues: [{type:'围挡脏污', detail:'围挡面板表面有泥浆污渍约0.5㎡，需清洁处理'}] },
