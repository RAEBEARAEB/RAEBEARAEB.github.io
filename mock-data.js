...
(function () {
  ...
  function _d(s) { var t = new Date(now); t.setDate(t.getDate() - s); return t.toISOString().slice(0,10); }
    ...
    var _demoIssues = [
      ...
      { id: 'YZY-002', type: '围挡脏污', fenceId: 'WD-2026-0002', fenceAddr: '福田区福华三路西侧', details: '围挡表面大面积泥浆污渍影响市容，面积约5㎡', status: '整改逾期', source: '监管巡查', reportTime: _d(7)+' 09:45:00', engineerName: '沟槽开挖工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', photos: ['../围挡破损.png'], location: { lat: 22.547, lng: 114.059, addr: '福田区福华三路西侧' } },
      { id: 'YZY-003', type: '围挡安全隐患', fenceId: 'WD-2026-0002', fenceAddr: '福田区福华三路西侧', details: '围挡整体向西侧倒塌约15米，底部基础完全裸露', status: '待整改', source: '监管巡查', reportTime: _d(5)+' 10:15:30', engineerName: '沟槽开挖工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', photos: ['../围挡破损.png'], location: { lat: 22.546, lng: 114.060, addr: '福田区福华三路西侧' } },
      { id: 'YZY-011', type: '围挡基础松动', fenceId: 'WD-2026-0001', fenceAddr: '福田区福华三路', details: '巡检中发现围挡底部基础螺栓松动3处，已当日加固修复', status: '整改完成', source: '项目巡检', reportTime: _d(8)+' 09:20:00', engineerName: '管道铺设工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', photos: ['../围挡破损.png'], location: { lat: 22.550, lng: 114.061, addr: '福田区福华三路与金田路交汇处' } },
      ...
      { id: 'YZY-013', type: '围挡脏污', fenceId: 'WD-2026-0001', fenceAddr: '福田区福华三路', details: '围挡表面有大量泥浆泼溅，影响城市市容，请尽快清洗处理', status: '待整改', source: '街道上报', reportTime: _d(2)+' 15:20:00', engineerName: '管道铺设工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', street: '福田街道', photos: ['../围挡破损.png'], location: { lat: 22.548, lng: 114.062, addr: '福田区福华三路金田路口东侧' } },
      { id: 'YZY-014', type: '围挡缺失', fenceId: 'WD-2026-0002', fenceAddr: '福田区福华三路西侧', details: '围挡西段缺失约8米，缺口处行人可随意进出施工区域，存在严重安全隐患', status: '待整改', source: '街道上报', reportTime: _d(3)+' 10:45:00', engineerName: '沟槽开挖工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', street: '福田街道', photos: ['../围挡破损.png'], location: { lat: 22.546, lng: 114.058, addr: '福田区福华三路西侧围挡缺口处' } },
      { id: 'YZY-015', type: '张贴小广告', fenceId: 'WD-2026-0001', fenceAddr: '福田区福华三路', details: '围挡立面被张贴大量小广告，面积约3㎡，影响市容整洁度', status: '整改逾期', source: '街道上报', reportTime: _d(9)+' 11:10:00', engineerName: '管道铺设工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', street: '福田街道', photos: ['../围挡破损.png'], location: { lat: 22.549, lng: 114.063, addr: '福田区福华三路中段' } },
      { id: 'YZY-016', type: '围挡安全隐患', fenceId: 'WD-2026-0001', fenceAddr: '福田区福华三路', details: '围挡面板连接处多处锈蚀严重，遇大风天气存在倒塌风险，需紧急加固', status: '待整改', source: '街道上报', reportTime: _d(1)+' 16:30:00', engineerName: '管道铺设工程', _projectName: '福田中心区市政管网改造工程', responsibleUnit: '深圳市市政工程总公司', street: '福田街道', photos: ['../围挡破损.png'], location: { lat: 22.550, lng: 114.060, addr: '福田区福华三路与金田路交汇处北侧' } },
      ...
      { id: 'YZY-029', type: '围挡喷淋不符合要求', fenceId: 'WD-2026-0001', fenceAddr: '南山区科技南路18号东北角', details: '绿化迁移围挡喷淋设施3处喷头堵塞不出水，不符合文明施工要求', status: '整改完成', source: '项目巡检', reportTime: _d(3)+' 08:45:00', engineerName: '绿化迁移工程', _projectName: '南山区科技园综合体项目', responsibleUnit: '深圳市绿篱建设工程有限公司', photos: ['../围挡破损.png'], location: { lat: 22.5365, lng: 113.960, addr: '南山区科技南路18号东北角绿化围挡处' } },
      ...
      { id: 'YZY-033', type: '围挡公益广告画面不连贯', fenceId: 'WD-2026-0004', fenceAddr: '龙华区民治街道民丰路88号', details: '教学楼围挡公益广告画面在东南角转角处断开约2米，整体视觉效果不连贯', status: '整改完成', source: '项目巡检', reportTime: _d(6)+' 14:50:00', engineerName: '教学楼主体工程', _projectName: '龙华区民治街道学校扩建项目', responsibleUnit: '深圳市建工集团股份有限公司', photos: ['../围挡破损.png'], location: { lat: 22.628, lng: 114.044, addr: '龙华区民治街道民丰路88号教学楼东南角围挡' } }
    ];
